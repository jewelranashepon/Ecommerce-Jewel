...
const FilterSection = () => {
  ...
  // to get unique data from all fields
  ...
  // const companyData = getUniqueData(all_products, "category");
  ...
  return (
    <Wrapper>
      ...
      <div className="filter-company">
        <h3>Company</h3>
        <form action="#">
          <select name="category" id="category" className="filter-company--select" onClick={updateFilterValue}>
            {
              categoryOnlyData.map((curElem, index) => {
                return (
